...
function Outbanner(){
 ...
 ██${RD}║${CL}████${RD}╗${CL}  ██${RD}║${CL}██${RD}╔════╝╚══${CL}██${RD}╔══╝${CL}  省事一键云机商店:github.com/minlearn/apps
...
case $tmpTARGET in
  ...
  devdeskos*|devdeskosfull|debianmu*|debianmufull) tmpTARGET=${tmpTARGET/debianmu/devdeskos}; [[ "${#tmpTARGET}" -gt '9' && "${tmpTARGET}" != "devdeskosfull" ]] && TARGETDDURL=${IMGMIRROR/xxxxxx/$tmpTARGET}"/"$tmpTARGET"/binary$([ "$tmpHOSTARCH" == '1' -a "$tmpHOSTARCH" != '' ]  && echo -arm64 || echo -amd64)/tarball" || TARGETDDURL=${IMGMIRROR/xxxxxx/1kdd}"/_build/devdeskos/binary$([ "$tmpHOSTARCH" == '1' -a "$tmpHOSTARCH" != '' ]  && echo -n -arm64 || echo -n -amd64)/tarball"
  ...
  debiandemu|debianctmu) TARGETDDURL=${IMGMIRROR/xxxxxx/1kdd}"/_build/devdeskos/binary$([ "$tmpHOSTARCH" == '1' -a "$tmpHOSTARCH" != '' ]  && echo -n -arm64 || echo -n -amd64)/tarball"
