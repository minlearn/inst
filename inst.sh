    ...
    -t|--target)
      ...
      case $tmpTARGET in
        ...
        [[ "$tmpTARGET" != 'devdeskct' && "$tmpTARGET" != 'devdeskde' ]] && { [[ ! ("$tmpTARGET" =~ 'devdeskos') ]] && tmpTARGET=${1/devdesk/devdeskos}
          ...
          [[ "$tmpTARGET" =~ 'devdeskos,' ]] && tmpTARGET='devdeskos' && tmpTARGETMODE='1' && echo "Fullgen mode detected,with pack addons:""$PACKCONTAINERS" |sed 's/,/ /g' && echo "and migrate addons:""$GENCONTAINERS" |sed 's/,/ /g'
