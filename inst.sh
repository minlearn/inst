...
dipreseedlatecommandstring="/usr/lib/debianinstall-patchs/postinstall.sh $DEBMIRROR"
  ...
  [[ "$tmpTARGET" == devdeskos* ]] && {
    choosevmlinuz=${TARGETDDURL/devdeskos/onekeydevdesk}/vmlinuz$([ "$tmpHOSTARCH" == '1' -a "$tmpHOSTARCH" != '' ]  && echo -n _arm64)
    chooseinitrfs=${TARGETDDURL/devdeskos/onekeydevdesk}/initrfs$([ "$tmpHOSTARCH" == '1' -a "$tmpHOSTARCH" != '' ]  && echo -n _arm64).img
...
case $tmpTARGET in
  ...
  devdeskos*) [[ "${#tmpTARGET}" -gt '9' && "${tmpTARGET}" != "devdeskosfull" ]] && TARGETDDURL=${IMGMIRROR/xxxxxx/$tmpTARGET}"/"$tmpTARGET"/binary$([ "$tmpHOSTARCH" == '1' -a "$tmpHOSTARCH" != '' ]  && echo -arm64 || echo -amd64)/tarball" || TARGETDDURL=${IMGMIRROR/xxxxxx/inst}"/_build/devdeskos/binary$([ "$tmpHOSTARCH" == '1' -a "$tmpHOSTARCH" != '' ]  && echo -n -arm64 || echo -n -amd64)/tarball"
  ...
  devdeskct|devdeskde) TARGETDDURL=${IMGMIRROR/xxxxxx/inst}"/_build/devdeskos/binary$([ "$tmpHOSTARCH" == '1' -a "$tmpHOSTARCH" != '' ]  && echo -n -arm64 || echo -n -amd64)/tarball"
