...
case $tmpTARGET in
  ...
  dummy) TARGETDDURL='' ;;
  deb|debian) TARGETDDURL='http://mirrors.aliyun.com' ;; # ${IMGMIRROR/xxxxxx/1keyddhubfree-debianbase} ;;
...
mkdir -p $downdir/onekeydevdesk $downdir/debianbase/dists/bullseye/main/binary-amd64/deb $downdir/debianbase/dists/bullseye/main/binary-arm64/deb $downdir/debianbase/dists/bullseye/main-debian-installer/binary-amd64/udeb $downdir/debianbase/dists/bullseye/main-debian-installer/binary-arm64/udeb $downdir/debianbase/dists-addons/{docker,extradeps,extradeps_arm64,lxc,qemu,qemuarm-fix,zfs-utils}
