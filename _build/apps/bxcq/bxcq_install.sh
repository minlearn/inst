...
sed -e s/host=\"127.0.0.1\"/host=\"\${HOSTNAME}\"/g -e s/pass=\"123456\"/pass=\"\${PASSWORD}\"/g -e s/port=3306/port=\${PORT}/g -i ${BXCQS_DIR}/build/AMServer/AMServer.txt
...
sed -e s/Host\ =\ \"127.0.0.1\"/Host\ =\"\${HOSTNAME}\"/g -e s/DBPass\ =\ \"123456\"/DBPass\ =\ \"\${PASSWORD}\"/g -e s/Port\ =\ 3306/Port\ =\ \${PORT}/g -i ${BXCQS_DIR}/build/BackStageServer/BackStageServer.txt
...
sed -e s/Host\ =\ \"127.0.0.1\"/Host\ =\"\${HOSTNAME}\"/g -e s/DBPass\ =\ \"123456\"/DBPass\ =\ \"\${PASSWORD}\"/g -e s/Port\ =\ 3306/Port\ =\ \${PORT}/g -i ${BXCQS_DIR}/build/LoggerServer/LoggerServer.txt
...
sed -e s/Host\ =\ \"127.0.0.1\"/Host\ =\"\${HOSTNAME}\"/g -e s/DBPass\ =\ \"123456\"/DBPass\ =\ \"\${PASSWORD}\"/g -e s/Port\ =\ 3306/Port\ =\ \${PORT}/g -i ${BXCQS_DIR}/build/NameServer/NameServer.txt
...
sed -e s/Host\ =\ \"127.0.0.1\"/Host\ =\"\${HOSTNAME}\"/g -e s/DBPass\ =\ \"123456\"/DBPass\ =\ \"\${PASSWORD}\"/g -e s/Port\ =\ 3306/Port\ =\ \${PORT}/g -i ${BXCQS_DIR}/build/SessionServer/SessionServer.txt
...
sed -e s/Host\ =\ \"127.0.0.1\"/Host\ =\"\${HOSTNAME}\"/g -e s/DBPass\ =\ \"123456\"/DBPass\ =\ \"\${PASSWORD}\"/g -e s/Port\ =\ 3306/Port\ =\ \${PORT}/g -i ${BXCQS_DIR}/Debug/DBServer/DBServer.txt
...
sed -e s/Host\ =\ \"127.0.0.1\"/Host\ =\"\${HOSTNAME}\"/g -e s/DBPass\ =\ \"123456\"/DBPass\ =\ \"\${PASSWORD}\"/g -e s/Port\ =\ 3306/Port\ =\ \${PORT}/g -i ${BXCQS_DIR}/Debug_cross/DBServer/DBServer.txt
...
sed -e "s/'DB_HOST'=>'127.0.0.1'/'DB_HOST'=>'\${HOSTNAME}'/g" -e "s/'DB_PORT'=>3306/'DB_PORT'=>\${PORT}/g" -e "s/'DB_PSWD'=>'123456'/'DB_PSWD'=>'\${PASSWORD}'/g" -i ${BXCQC_DIR}/login/api/reg.php
