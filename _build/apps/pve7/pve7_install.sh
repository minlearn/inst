...
# iso release date
COMPARE_TS="2023-03-23T17:00:00Z"
compare_epoch=$(date -d "$COMPARE_TS" +"%s")

PACKAGES_URL="https://mirrors.ustc.edu.cn/proxmox/debian/pve/dists/bullseye/pve-no-subscription/binary-amd64/Packages"
...
curl -fsSL https://mirrors.ustc.edu.cn/proxmox/debian/proxmox-release-bullseye.gpg | gpg --dearmor  -o /etc/apt/trusted.gpg.d/proxmox-release-bullseye.gpg
#echo "deb https://mirrors.ustc.edu.cn/proxmox/debian/devel bullseye main" >/etc/apt/sources.list.d/pvedevel.list
echo "deb https://mirrors.ustc.edu.cn/proxmox/debian/pve bullseye pve-no-subscription" >/etc/apt/sources.list.d/pvenosub.list
apt-get update
