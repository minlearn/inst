...
down(){
  mkdir -p p4/down;
  for i in grub-common_2.06-3-deb11u5_amd64.deb grub-pc-bin_2.06-3-deb11u5_amd64.deb grub-efi-amd64-bin_2.06-3-deb11u5_amd64.deb debootstrap-udeb_1.0.123-deb11u1_all.udeb bootstrap-base_1.206_amd64.udeb; do
...
dobootstrap(){
  ...
  ar -p p4/down/bootstrap-base_1.206_amd64.udeb data.tar.xz |xzcat|tar -xf - -C / --no-overwrite-dir --keep-directory-symlink --strip-components=1
