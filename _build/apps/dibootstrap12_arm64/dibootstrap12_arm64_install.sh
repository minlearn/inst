...
silent apt-get install -y xsltproc docbook-xml docbook-xsl bogl-utils genext2fs genisoimage dosfstools bc syslinux syslinux-utils isolinux pxelinux syslinux-common shim-signed grub-efi-arm64-signed xorriso tofrodos mtools unifont unifont-bin pigz depthcharge-tools win32-loader librsvg2-bin
