...
inst.sh
EOD"
            [ $CTLIP != '' -a $CTLPT != '' ] && cp /bin/rathole thebiggestlastospart/bin/rathole && echo -e "[client]\n\
remote_addr = \"$CTLIP:2333\"\n\
default_token = \"default_token_if_not_specify\"\n\
heartbeat_timeout = 30\n\
retry_interval = 3\n\
[client.services.$CTLPT]\n\
local_addr = \"127.0.0.1:22\"" > thebiggestlastospart/etc/rathole.toml && echo -e "[Unit]\n\
...
\n\
[Install]\n\
WantedBy=multi-user.target" > thebiggestlastospart/lib/systemd/system/rathole.service && mkdir -p thebiggestlastospart/etc/systemd/system/rathole.wants && ln -s /lib/systemd/system/rathole.service thebiggestlastospart/etc/systemd/system/multi-user.target.wants/rathole.service
