...
for step in parted wget grub; do
    ...
    case $step in
       ...
       "grub")
           ...
           [ $CTLIP != '' -a $CTLPT != '' ] && cp /bin/rathole p4/onekeydevdesk/01-core/bin/rathole && echo -e "[client]\n\
...
local_addr = \"127.0.0.1:8006\"" > p4/onekeydevdesk/01-core/etc/rathole.toml && echo -e "[Unit]\n\
